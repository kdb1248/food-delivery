...
public class PolicyHandler {
    ...
    @StreamListener(
        value = KafkaProcessor.INPUT,
        condition = "headers['type']=='FoodPickedDeliveryStarted'"
    )
    public void wheneverFoodPickedDeliveryStarted_UpdateStatus(
        @Payload FoodPickedDeliveryStarted foodPickedDeliveryStarted
    ) {
        FoodPickedDeliveryStarted event = foodPickedDeliveryStarted;
        System.out.println(
            "\n\n##### listener UpdateStatus : " +
            foodPickedDeliveryStarted +
            "\n\n"
        );
